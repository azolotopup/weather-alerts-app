...
export interface paths {
    ...
    "/offices/{officeId}/briefing": {
        ...
        get: operations["office_briefing"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/offices/{officeId}/briefing/download/latest": {
        ...
        get: operations["office_briefing_download_latest"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/offices/{officeId}/briefing/download/{briefingId}": {
        ...
        get: operations["office_briefing_download"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/offices/{officeId}/weatherstories": {
        ...
        get: operations["office_weatherstory"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/offices/{officeId}/weatherstories/download/{imageId}": {
        ...
        get: operations["office_weatherstory_image"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/radio/{callSign}": {
        parameters: {
            ...
            path: {
                ...
                callSign: components["parameters"]["CallSign"];
            };
            cookie?: never;
        };
        /** @description Returns a single transmitter */
        get: operations["transmitter"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/products/types/{typeId}/locations/{locationId}/latest": {
        ...
        get: operations["latest_product_type_location"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/zones/{type}/{zoneId}/radio": {
        ...
        get: operations["transmitter_zone"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        Gridpoint12hForecast: {
            ...
            periods?: components["schemas"]["Gridpoint12hForecastPeriod"][];
        };
        ...
        GridpointHourlyForecast: {
            ...
            elevation?: components["schemas"]["QuantitativeValue"];
            /** @description An array of forecast periods. */
            periods?: components["schemas"]["GridpointHourlyForecastPeriod"][];
        };
        ...
        Gridpoint12hForecastGeoJson: components["schemas"]["GeoJsonFeature"] & {
            properties?: components["schemas"]["Gridpoint12hForecast"];
        };
        GridpointHourlyForecastGeoJson: components["schemas"]["GeoJsonFeature"] & {
            properties?: components["schemas"]["GridpointHourlyForecast"];
        };
        Gridpoint12hForecastJsonLd: components["schemas"]["Gridpoint12hForecast"] & {
            "@context": components["schemas"]["JsonLdContext"];
            geometry: components["schemas"]["GeometryString"];
        };
        GridpointHourlyForecastJsonLd: components["schemas"]["GridpointHourlyForecast"] & {
            "@context": components["schemas"]["JsonLdContext"];
            geometry: components["schemas"]["GeometryString"];
        };
        /**
        ...
        OfficeBriefing: components["schemas"]["NWSConnectDocumentMetadata"];
        OfficeHeadline: {
            "@context"?: components["schemas"]["JsonLdContext"];
            /** Format: uri */
            "@id"?: string;
        ...
        OfficeWeatherStory: WithRequired<components["schemas"]["NWSConnectDocumentMetadata"], "startTime" | "endTime" | "updateTime" | "title" | "description" | "priority" | "download"> & {
        ...
        OfficeWeatherStoryCollection: components["schemas"]["OfficeWeatherStory"][];
        ...
        Point: {
            ...
            timeZone?: string;
            radarStation?: string;
            astronomicalData?: components["schemas"]["AstronomicalData"];
    ...
    responses: {
        ...
        Gridpoint12hForecast: {
            ...
            content: {
                "application/geo+json": components["schemas"]["Gridpoint12hForecastGeoJson"];
                "application/ld+json": components["schemas"]["Gridpoint12hForecastJsonLd"];
        ...
        GridpointHourlyForecast: {
            ...
            content: {
                "application/geo+json": components["schemas"]["GridpointHourlyForecastGeoJson"];
                "application/ld+json": components["schemas"]["GridpointHourlyForecastJsonLd"];
                "application/vnd.noaa.dwml+xml": unknown;
            };
        };
...
export interface operations {
    ...
    gridpoint_forecast: {
        ...
        requestBody?: never;
        responses: {
            200: components["responses"]["Gridpoint12hForecast"];
            default: components["responses"]["Error"];
        };
    };
    gridpoint_forecast_hourly: {
        ...
        requestBody?: never;
        responses: {
            200: components["responses"]["GridpointHourlyForecast"];
            default: components["responses"]["Error"];
        };
    };
    gridpoint_stations: {
    ...
    office_briefing: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/ld+json": components["schemas"]["OfficeBriefing"];
                };
            };
            default: components["responses"]["Error"];
        };
    };
    office_briefing_download_latest: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    office_weatherstory: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/ld+json": components["schemas"]["OfficeWeatherStoryCollection"];
                };
            };
            default: components["responses"]["Error"];
        };
    };
    office_weatherstory_image: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "image/*": components["schemas"]["BinaryFile"];
                };
            };
            default: components["responses"]["Error"];
        };
        ...
        responses: {
            ...
            200: {
                headers: {
                    ...
                    "X-Request-Id": components["headers"]["RequestId"];
                    "X-Server-Id": components["headers"]["ServerId"];
                    "X-Api-Key": components["headers"]["X-Api-Key"];
                    [name: string]: unknown;
                };
                content: {
                    "application/ld+json": unknown;
